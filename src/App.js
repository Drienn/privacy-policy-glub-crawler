...
const App = () => (
  <div>
    ...
    <p>Effective date: December 29, 2018</p>

    <p>
      Club Crawler ("us", "we", or "our") operates the Club Crawler mobile
    ...
    <ul>
      <li>
        ...
        <p>
          Service is the Club Crawler mobile application operated by Club
          Crawler
        </p>
      </li>
      <li>
    ...
    <h2>Use of Data</h2>
    <p>Club Crawler uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      If you are from the European Economic Area (EEA), Club Crawler legal basis
    ...
    <p>Club Crawler may process your Personal Data because:</p>
    <ul>
    ...
    <p>
      Club Crawler will retain your Personal Data only for as long as is
    ...
    <p>
      Club Crawler will also retain Usage Data for internal analysis purposes.
    ...
    <p>
      Club Crawler will take all the steps reasonably necessary to ensure that
    ...
    <p>
      If Club Crawler is involved in a merger, acquisition or asset sale, your
    ...
    <p>
      Under certain circumstances, Club Crawler may be required to disclose your
    ...
    <p>
      Club Crawler may disclose your Personal Data in the good faith belief that
      such action is necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of Club Crawler</li>
      <li>
    ...
    <p>
      ...
      certain data protection rights. Club Crawler aims to take reasonable steps
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          right to withdraw your consent at any time where Club Crawler relied
    ...
    <ul>
      <li>By email: dinerdeciderhelp@gmail.com</li>
    </ul>
  </div>
);
